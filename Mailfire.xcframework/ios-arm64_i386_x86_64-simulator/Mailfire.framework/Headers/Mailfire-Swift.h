...
// Generated by Apple Swift version 5.3.2 (swiftlang-1200.0.44.1 clang-1200.0.32.28)
#ifndef MAILFIRE_SWIFT_H
#define MAILFIRE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Mailfire",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
///
/// \endcode
SWIFT_CLASS("_TtC8Mailfire8Mailfire")
@interface Mailfire : NSObject
...
///
/// \param appId Mailfire SDK App Id obtained from developer portal at https://api.mailfire.io
///
